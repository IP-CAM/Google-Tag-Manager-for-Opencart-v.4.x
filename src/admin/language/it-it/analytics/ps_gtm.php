...
$_['text_troubleshot']              = '<ul><li><strong>ID di misurazione non trovato:</strong> Verifica che l\'ID di misurazione inserito nelle impostazioni dell\'estensione sia corretto. Assicurati che non ci siano spazi extra o caratteri errati.</li><li><strong>Tag non attivi:</strong> Verifica che i tuoi tag siano configurati correttamente in Google Tag Manager con i giusti trigger. Puoi utilizzare <a href="https://tagassistant.google.com/" target="_blank" rel="noopener noreferrer">Google Tag Assistant</a> per risolvere i problemi di attivazione dei tag.</li><li><strong>Problemi di autorizzazione:</strong> Assicurati di avere i permessi necessari nel tuo account Google Tag Manager per creare e gestire i tag.</li><li><strong>Problemi di compatibilità:</strong> Assicurati che la tua versione di OpenCart sia aggiornata e verifica che nessuna altra estensione installata stia interferendo con la configurazione di Google Tag Manager.</li></ul>';
...
$_['help_gtm_id_locate']            = 'Per trovare il tuo ID di misurazione, accedi al tuo <a href="https://tagmanager.google.com" target="_blank" rel="external noopener noreferrer">account Google Tag Manager</a>. Nella dashboard del workspace, cerca l\'ID in alto—inizia con "GTM-" seguito da una serie unica di lettere e numeri, come "GTM-XXXXXXX". <a href="https://support.google.com/analytics/answer/12270356?hl=it" target="_blank" rel="external noopener noreferrer">Istruzioni dettagliate qui</a>.';
...
$_['error_gtm_id_invalid']          = 'Il formato dell\'ID di misurazione è errato. Assicurati che segua il formato GTM-XXXXXXX.';
